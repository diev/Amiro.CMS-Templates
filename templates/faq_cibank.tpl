...
<!--#set var="cat_lname_links" value="<!--cat_lname_links-->
	<div style="padding-bottom:15px;"><div class="alt_header4"><a href="##script_link####nav_data##&catoffset=##catoffset###ccat">##name##</a></div></div>
"-->
...
<!--#set var="small_cat_detail" value="
	<div##if(urgent)## class="urgent_cat_row"##endif##>
		<a href="##front_link####cat_nav_data##">##cat_name##</a><br>
	</div>
"-->

<!--#set var="small_row" value="
	<div##if(urgent)## class="urgent_item_row"##endif##>
		##--<b>##cat_detail##</b>--##
...
<!--#set var="body_items" value="<!--body_items-->
	...
	##--filter--##
	##cat_list##
	##--<p><a name="ccat" href="##script_link##?##front_cats_link##">%%faq%%</a></p>--##
	##--<h2>##cat_name##</h2>--##
	<p>##cat_announce##</p>
	##--sort--##
	##question_list##
